#!/usr/bin/env python3
"""
Ollama BGE LangCache Service
A LangCache-compatible service using BGE embeddings
"""
...
def health():
    ...
    return jsonify({'status': 'healthy', 'service': 'ollama-bge'})
...
def create_cache():
    ...
    try:
        ...
        embedding_model_name = data.get('embeddingModel', 'ollama-bge')
        ...
        print(f"Created Ollama BGE cache: {cache_id}")
